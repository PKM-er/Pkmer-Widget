 ...
 * @LastEditTime: 2023-11-03 22:26:55
 * @Description: 
-->
...
watchEffect(() => {
  ...
  if (props.widgetConfig["select-background"] == "Color")
    props.widgetConfig["input-url"] = "";
...
<template>
  <div
    ...
    :style="{
      margin: 'auto',
      background:
        props.widgetConfig['layout-style'] == 'Note' ? themeColor_DD : '',
      width: props.widgetConfig['layout-style'] == 'Note' ? '240px' : '',
    }"
  >
    <div
      class="sticky"
        ...
        background:
          props.widgetConfig['select-background'] != 'Color'
            ...
            : ` -webkit-radial-gradient(center, cover, ${tinycolor(themeColor_B)
                ...
                themeColor_L
              ).setAlpha(0.7)} 29px, ${tinycolor(themeColor_L).setAlpha(
                0.7
              )} 30px)`,
...
.notepaper {
  ...
  -webkit-box-shadow: inset 0 1px v-bind(themeColor_D),
    inset 0 0 5px v-bind(themeColor_B) 0 0 1px rgba(0, 0, 0, 0.1),
    0 2px rgba(0, 0, 0, 0.02);
  box-shadow: inset 0 1px v-bind(themeColor_D),
    inset 0 0 5px v-bind(themeColor_B), 0 0 1px rgba(0, 0, 0, 0.1),
    0 2px rgba(0, 0, 0, 0.02);
}
