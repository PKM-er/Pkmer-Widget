		...
		<div class="row">
			<div class="flipTimemodulesboxes">
				<div class="flipTimebox">
					<div class="flipclock1 flip-clock-wrapper" :class="props.widgetConfig['select-theme']">
						<span class="flip-clock-divider hours"
							><span class="flip-clock-label">Hours</span><span class="flip-clock-dot top"></span
							...
							<li :class="hours_ones == 0 ? 'flip-clock-before' : ''">
								<a href="#"
									><div class="up">
										...
										<div class="inn">
											{{ hours_ones == 0 ? Math.max(hours_tens - 1, 0) : hours_tens }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="hours_ones == 0 ? 'flip-clock-active' : ''">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ hours_ones == 0 ? hours_tens : Math.max(hours_tens - 1, 0) }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="minute_tens == 0 ? 'flip-clock-before' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ minute_tens == 0 ? Math.max(hours_ones - 1, 0) : hours_ones }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="minute_tens == 0 ? 'flip-clock-active' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ minute_tens == 0 ? hours_ones : Math.max(hours_ones - 1, 0) }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
						...
						<span class="flip-clock-divider minutes"
							><span class="flip-clock-label">Minutes</span><span class="flip-clock-dot top"></span
							><span class="flip-clock-dot bottom"></span
						></span>
						<ul class="flip play">
							<li :class="minute_ones == 0 ? 'flip-clock-before' : ''">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ minute_ones == 0 ? Math.max(minute_tens - 1, 0) : minute_tens }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="minute_ones == 0 ? 'flip-clock-active' : ''">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ minute_ones == 0 ? minute_tens : Math.max(minute_tens - 1, 0) }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="second_tens == 0 ? 'flip-clock-before' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ second_tens == 0 ? Math.max(minute_ones - 1, 0) : minute_ones }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="second_tens == 0 ? 'flip-clock-active' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ second_tens == 0 ? minute_ones : Math.max(minute_ones - 1, 0) }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
						...
						<span class="flip-clock-divider seconds"
							><span class="flip-clock-label">Seconds</span><span class="flip-clock-dot top"></span
							><span class="flip-clock-dot bottom"></span
						></span>
						<ul class="flip play">
							<li :class="second_ones == 0 ? 'flip-clock-before' : ''">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ second_ones == 0 ? Math.max(second_tens - 1, 0) : second_tens }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
							...
							<li :class="second_ones == 0 ? 'flip-clock-active' : ''">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">
											{{ second_ones == 0 ? second_tens : Math.max(second_tens - 1, 0) }}
										</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
						...
						<ul class="flip play">
							<li :class="flip ? 'flip-clock-before' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">{{ flip ? Math.max(second_ones - 1, 0) : second_ones }}</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
										<div class="inn">{{ flip ? Math.max(second_ones - 1, 0) : second_ones }}</div>
							...
							<li :class="flip ? 'flip-clock-active' : ' '">
								<a href="#"
									><div class="up">
										<div class="shadow"></div>
										<div class="inn">{{ flip ? second_ones : Math.max(second_ones - 1, 0) }}</div>
									</div>
									<div class="down">
										<div class="shadow"></div>
										<div class="inn">{{ flip ? second_ones : Math.max(second_ones - 1, 0) }}</div>
